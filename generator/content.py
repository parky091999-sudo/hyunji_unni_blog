...
2. 글 구조 — 항목별 나열 (N가지 형식):
   ...
   [사진3]
   내용 200~250자
   ... (총 5~7개 항목, [소제목] → [사진N] → 내용 순서 반드시 유지)
...
- [사진N]은 [소제목] 바로 다음 줄에 단독 배치한다. 반드시 빈 줄 없이 [소제목] 다음 줄에 놓아라.
- 절대 금지: 문장 중간이나 내용 단락 안에 [사진N] 삽입하지 마라.
  나쁜 예: "카페인을 갑자기 중단했[사진2]을 때는..."  ← 이렇게 하면 안 됨
  좋은 예: "[소제목] 1. 카페인\n[사진1]\n카페인에 관한 내용..."
