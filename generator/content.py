...
벤치마크: 한국 건강 블로그 최상위 스타일 — 인포그래픽 + ①②③ 원형 번호 + 소제목별 이미지 + 가운데 정렬.

══════════════════════════════════════════
[제목 패턴 — 검색 유입 최적화]
══════════════════════════════════════════
- "~이 아니었습니다 | 의외의 N가지 이유"
- "~때문이었습니다 | 전문가가 밝힌 진짜 원인"
- "~에 좋은 음식 N가지 | 연구로 증명된 효과"
- "굶어도 안 되는 이유 | ~해결법 N가지"
형식: [공감/반전] | [숫자형 정보] — 30자 이내

══════════════════════════════════════════
[글 구조 — 반드시 이 순서 그대로]
══════════════════════════════════════════

[사진1]            ← 브랜드 헤더카드 (본문 최상단 첫 줄, 절대 변경 금지)
도입부 3~4줄 — 독자 고민 공감 + 핵심 정보. "안녕하세요/오늘은" 금지.

[사진2]            ← AI 인포그래픽 (도입부 바로 다음, 전체 내용 미리보기)

[소제목] ① 첫 번째 항목명
[사진3]            ← 항목 관련 사진 (소제목 바로 다음 줄, 내용보다 앞)
내용 250~350자:
  • 연구 기관명 + 인원/기간 + **수치 결과** (굵게)
  • 실생활 활용법 1~2줄
  • 음식/방법 목록 있으면 • 불렛으로 나열
...
... (총 N개 항목, 반드시 [소제목 ①②③..] → [사진N] → 내용 순서 절대 준수)

[마무리] 2~3줄 — 전문의 상담 권장 + 실천 격려

══════════════════════════════════════════
[핵심 원칙]
══════════════════════════════════════════
1. [사진N] 위치 절대 규칙:
   - [사진1]: 본문 첫 번째 줄 (도입부보다 앞)
   - [사진2]: 도입부 직후 (인포그래픽 위치)
   - [사진3..]: 각 [소제목] 바로 다음 줄 (내용보다 앞)
   - 절대 금지: 문장 중간이나 내용 단락 내부에 [사진N] 삽입
2. 핵심 수치·통계는 **텍스트** 형태로 굵게 표시
3. 각 항목 내 불렛(•) 활용으로 스캔 가독성 향상
4. 금지: 안녕하세요/이처럼/이로써/혁신적인/마크다운(#)
...
IMAGE_KEYWORDS: health header,health infographic,{사진3 영어},{사진4 영어},...
IMAGE_LABELS: {키워드},{키워드},사진3 한글,사진4 한글,...
---
{본문 — [사진1] 첫 줄, [사진2] 도입부 직후, [소제목①②③]→[사진N]→내용 구조, 총 2000자 이상}
"""
...
- --- 구분선
- [사진N] 마커 위치와 개수 (절대로 문장 중간에 이동 금지)
- [소제목] 마커와 그 뒤의 ①②③ 번호 형식
