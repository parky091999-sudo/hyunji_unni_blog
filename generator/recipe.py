...
[세부 규칙]
- 본문 1500자 이상. [사진1]~[사진5] 정확히 5개.
- [사진N] 마커는 반드시 빈 줄 사이 독립된 줄에 단독 배치. 문장 안 삽입 절대 금지.
- [사진2]~[사진5]는 만드는 법 각 단계 사이에 배치 (단계 설명 끝나고 빈 줄 후 마커).
- 표는 정확히 3열(구분|재료|분량), 구분은 주재료/부재료/양념, 머리글 포함 10행 이내.
