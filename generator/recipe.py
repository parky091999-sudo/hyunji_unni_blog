...
- AI틱 표현 금지: 이로써/이처럼/뿐만 아니라/마무리로/정리하자면/다양한 ~/도움이 되길/기억하세요/매우 ~/살펴보겠습니다/첫째, 둘째/지금부터, 별표·해시태그·마크다운 금지.
...
- ★절대 규칙★: 모든 [사진N] 마커는 절대 문장 한가운데 삽입하지 말고, 문장이 완전히 끝난 뒤 줄바꿈하여 독립된 새로운 줄에 단독 배치할 것.
- 재료표는 ★정확히 3열★ (구분 | 재료 | 분량). 구분은 '주재료/부재료/양념' 중 하나. 머리글 포함 9행 이내로 핵심 재료만.
- 소제목은 [소제목] 마커로 시작하는 한 줄. 이모지·기호 금지.
- ★중요 (AEO 지식스니펫 노출):★ 모든 소제목 바로 아래 첫 단락의 1~2문장은 핵심 해결법 및 요약을 즉시 두괄식으로 답변할 것 (서술 지연 금지).
- 한국어만.
""".strip()
