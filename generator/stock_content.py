...
def _struct_upper(cfg: dict) -> str:
    return (
        ...
        "\n[소제목] 상한가, 이거 하나는 꼭 보세요 — 거래대금\n"
        "(쉬운 해석: 상한가여도 실제 거래된 금액(거래대금)이 적으면 소수 매수세로 억지로 올린 것일 수 있어 다음날 "
        "쉽게 빠질 수 있음. 거래대금이 크게 실린 상한가일수록 그만큼 많은 사람이 사고팔며 인정한 상승이라 신뢰도가 높다고 봄. "
        "구체 수치는 데이터에 있을 때만 인용. 불릿 3줄.)\n"
