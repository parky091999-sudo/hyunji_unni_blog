...
### ★현재 방향 (2026-06-30 피벗): 고CPC 정보성 6카테고리
- **주제:** 2030 신혼·1인가구가 꼭 알아야 할 **돈·제도·건강 정보** (생활밀착 고정보)
- **6카테고리:** ①정부지원·혜택 ②건강·의료 ③금융·재테크 ④세금·절세 ⑤보험 ⑥부동산·주거 (전부 고CPC, "2030 생활금융&건강 정보"로 응집 → C-Rank 주제집중)
...
### 보관(삭제 금지): 살림 잡블로그 자료 (추후 별도 블로그용)
- 살림(`_SYSTEM`/daily_post)·레시피(recipe.py)·일상 프롬프트·스크립트 **전부 유지**. 크론만 정지.
- 살림 페르소나(20대 후반 신혼주부, 다이소/이케아 가성비 살림)는 그 블로그용으로 보존.
